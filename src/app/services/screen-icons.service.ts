...
export class ScreenIconsService {
  ...
  public readonly screen_icons: ScreenIconModel[] = [
    {id: 0, name: 'Service', url: 'assets/icons/service-icon.svg', x: 3, y: 0, is_chosen: false},
    {id: 1, name: 'Contacts', url: 'assets/icons/contact-icon.svg', x: 1, y: 0, is_chosen: false},
    {id: 2, name: 'About us', url: 'assets/icons/about-us-icon.svg', x: 0, y: 0, is_chosen: false},
    {id: 3, name: 'Clothes', url: 'assets/icons/clothes.png', x: 2, y: 0, is_chosen: false},
  ];
  public ChoosingIcon: boolean = false;
